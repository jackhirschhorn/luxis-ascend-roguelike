...
public class animationtrigger : StateMachineBehaviour
{
	...
	public string enter;
	public string enteroff;
	public string enteron;
    // OnStateEnter is called when a transition starts and the state machine starts to evaluate this state
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        if(enter != null)animator.SetBool(enter,!animator.GetBool(enter));
		if(enteroff != null)animator.SetBool(enteroff,false);
		if(enteron != null)animator.SetBool(enteron,true);
    }
    ...
    override public void OnStateExit(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
		...
		if(exiton != null)animator.SetBool(exiton,true);
